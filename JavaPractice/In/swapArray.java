...
public class swapArray {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(Arrays.toString(arr));//it will generate string value - easy to read

  }
    static void Swapp(int[] arry,int index1, int index2){  //fuction to swap two numbers where array-'arr', and its two index values are taken
